  ...
  return (
    <div className="flex flex-col justify-center">
        ...
        <div className="flex flex-col mx-12">
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center">
            ...
            <div className="flex pt-10">
              ...
              {/* Portrait */}
              <div className="flex flex-col justify-end ml-[-120px] lg:ml-[-200px] z-0 w-[240px] lg:w-[350px] mb-[-15px]">
                <Image
      ...
      <div className="flex flex-col items-center bg-gray-900 pt-4">
        ...
        <div className="flex items-center justify-center mt-[40px] lg:mt-[60px] flex-wrap mx-6">
